...
const HeroSection = ({ name }) => {
    ...
    const socialLinks = [
        ...
        { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>, href: 'https://facebook.com/hilalahmad', color: 'hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2]', title: 'Facebook' },
        { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>, href: 'mailto:hilalahmad146@gmail.com', color: 'hover:bg-[#EA4335] hover:text-white hover:border-[#EA4335]', title: 'Email' },
    ];
